...
export const SectionTitle = styled.h2`
  ...
  width: max-content;
  max-width: 100%;
  background: linear-gradient(121.57deg, #574336 18.77%, rgba(87, 67, 54, 0.8) 60.15%);
...
export const SubSectionTitle = styled.h3`
  ...
  line-height: ${(props) => props.main ? '62px' : '42px'};
  width: max-content;
  max-width: 100%;
  margin-left: 40px;
  background: linear-gradient(121.57deg, #574336 18.77%, rgba(87, 67, 54, 0.8) 60.15%);
...
export const ButtonBack = styled.div`
  width: ${({ alt }) => alt ? '50px' : '150px'};
  height: ${({ alt }) => alt ? '30px' : '35px'};
  border-radius: 50px;
  ...
  @media ${(props) => props.theme.breakpoints.md} {
    width: ${({ alt }) => alt ? '50px' : '100px'};
    height: ${({ alt }) => alt ? '52px' : '48px'};
    font-size: ${({ alt }) => alt ? '20px' : '16px'};
    margin-bottom: ${({ alt }) => alt ? '20px' : '35px'};
  }
  @media ${(props) => props.theme.breakpoints.sm} {
    width: 100px;
    height: 32px;
